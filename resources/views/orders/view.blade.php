...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ __('orders.orders_view_title') }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">{{ __('orders.home') }}</a></li>
                        <li class="breadcrumb-item active">{{ __('orders.order_view_breadcrumb') }}</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div>
                                    <table class="table table-striped table-bordered">
                                        <tbody>
                                            ...
                                            @endforeach
                                            <tr>
                                                <td colspan="10" class="text-right font-weight-bold">{{ __('orders.total') }}</td>
